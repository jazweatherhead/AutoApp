...
// lowerCaseSingular, upperCaseSingular, titleCaseSingular, lowerCasePlural, titleCasePlural
...
{ file: 'api/routes/index.js',
  content: "var express = require(\'express\');\nvar router = express.Router();\nvar ctrlMovies = require(\'../controllers/" + lowerCasePlural + "\');\n\n/* Movies */\nrouter.get(\'/" + lowerCasePlural + "\', ctrlMovies." + lowerCasePlural + "List); // list all\nrouter.post(\'/" + lowerCasePlural + "\', ctrlMovies." + lowerCasePlural + "Create); // C\nrouter.get(\'/" + lowerCasePlural + "/:movieid\', ctrlMovies." + lowerCasePlural + "ReadOne); // R\nrouter.put(\'/" + lowerCasePlural + "/:movieid\', ctrlMovies." + lowerCasePlural + "UpdateOne); // U\nrouter.delete(\'/" + lowerCasePlural + "/:movieid\', ctrlMovies." + lowerCasePlural + "DeleteOne); // D\n\nmodule.exports = router;"},
